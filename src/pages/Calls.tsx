      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card className="p-5">
          <div className="flex items-center justify-between">
            ...
            <div className="icon-box flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--surface-hover)] text-[var(--text-secondary)]">
              <Clock size={18} />
            </div>
          </div>
        </Card>
        <Card className="p-5">
          <div className="flex items-center justify-between">
            ...
            <div className="icon-box flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-600">
        ...
        <Card className="p-5">
          <div className="flex items-center justify-between">
            ...
            <div className="icon-box flex h-10 w-10 items-center justify-center rounded-xl bg-red-500/10 text-red-600">
              <PhoneMissed size={18} />
            </div>
          </div>
        </Card>
        <Card className="p-5">
          <div className="flex items-center justify-between">
            ...
            <div className="icon-box flex h-10 w-10 items-center justify-center rounded-xl bg-blue-500/10 text-blue-600">
          ...
          {mockCalls.map((call) => (
            <div key={call.id} className="flex items-center justify-between gap-4 p-4 hover:bg-[var(--surface-hover)] transition-colors group">
              <div className="flex items-center gap-4 min-w-0">
                <div className={`icon-box flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ${
