...
const staticSystems: IntegrationSystem[] = [
  {
    ...
    latency: '124ms',
    recentErrors: [
      { time: '11:42 AM', code: '408', message: 'Lorem ipsum dolor sit amet', endpoint: 'Lorem ipsum' },
      { time: '3:15 AM', code: '429', message: 'Lorem ipsum dolor sit amet consectetur', endpoint: 'Lorem ipsum' },
    ],
    eventLog: [
      { time: '12:58 PM', event: 'Lorem ipsum dolor sit amet (#SF-4892)', type: 'info' },
      { time: '12:45 PM', event: 'Lorem ipsum dolor sit amet consectetur', type: 'info' },
      { time: '11:42 AM', event: 'Lorem ipsum dolor sit amet', type: 'warning' },
      { time: '10:30 AM', event: 'Lorem ipsum dolor sit amet (#SF-4891)', type: 'info' },
      { time: '9:15 AM', event: 'Lorem ipsum dolor sit amet', type: 'info' },
    ],
    rootCause: null,
    recommendation: null,
    uptimeHistory: [
