...
export const mockLeadActivities: LeadActivity[] = [
  ...
  { id: 'a1', lead_id: '1', platform: 'website', type: 'website_visit', title: 'Website visit', description: 'Visited /free-consultation page — PI case evaluation', agent_name: null, metadata: { page: '/free-consultation', referrer: 'organic' }, created_at: '2024-02-05T10:28:00Z' },
  ...
  { id: 'a17', lead_id: '3', platform: 'salesforce', type: 'salesforce_synced', title: 'Synced to Salesforce', description: 'Lead record created in Salesforce CRM', agent_name: 'System', metadata: { salesforce_id: 'SF-2024-0891' }, created_at: '2024-02-05T10:00:00Z' },
  ...
  { id: 'a19', lead_id: '4', platform: 'website', type: 'website_visit', title: 'Website visit', description: 'Visited /car-accident-lawyer page', agent_name: null, metadata: { page: '/car-accident-lawyer', referrer: 'organic' }, created_at: '2024-02-03T09:55:00Z' },
  ...
  { id: 'a33', lead_id: '6', platform: 'salesforce', type: 'salesforce_case_created', title: 'Salesforce case created', description: 'Case #SF-2024-0887 — Personal Injury', agent_name: 'System', metadata: { salesforce_id: 'SF-2024-0887', case_type: 'Personal Injury' }, created_at: '2024-02-04T14:00:00Z' },
  ...
  { id: 'a37', lead_id: '6', platform: 'salesforce', type: 'salesforce_synced', title: 'Salesforce record updated', description: 'Status synced: Retained', agent_name: 'System', metadata: { salesforce_id: 'SF-2024-0887' }, created_at: '2024-02-05T10:16:00Z' },
  ...
  { id: 'a40', lead_id: '7', platform: 'internal', type: 'email_sent', title: 'Auto-reply email sent', description: 'Thank you for contacting us — intake packet attached', agent_name: 'System', metadata: { subject: 'Thank You — Wilshire Law Firm' }, created_at: '2024-02-03T13:21:00Z' },
  ...
  { id: 'a54', lead_id: '9', platform: 'salesforce', type: 'salesforce_synced', title: 'Synced to Salesforce', description: 'Lead record created in Salesforce CRM', agent_name: 'System', metadata: { salesforce_id: 'SF-2024-0895' }, created_at: '2024-02-04T10:00:00Z' },
