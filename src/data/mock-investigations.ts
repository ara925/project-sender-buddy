...
export const investigations: Investigation[] = [
  {
    ...
    severity: 'critical',
    status: 'open',
    flag: 'Honeypot alert — lead data exported and shared externally',
    aiSummary: 'Agent accessed honeypot record HP-001 (Maria Delgado — Premises Liability) at 11:02 AM and exported the full case summary. Within 12 minutes, the burner phone received an inbound call from (510) 555-0342, linked to Rivera & Associates. This confirms a pre-established referral channel for selling high-value PI leads.',
    details: 'CRM access log shows agent viewed and exported honeypot data within 3 minutes. Burner phone (408) 555-0177 received contact from competing firm. Cross-reference shows agent accessed 4 other high-value premises liability cases this month she was not assigned to.',
    flaggedAt: '2026-02-13T11:14:00Z',
    indicators: ['Honeypot data accessed', 'Case summary exported to PDF', 'Burner phone contacted by competing firm within 12 min'],
  },
  {
    id: 'inv-2',
    leadId: '11',
  ...
  },
  {
    ...
    aiSummary: 'Email monitoring detected lead contact information sent to a non-company email address (a.williams.personal@gmail.com). The data included Sandra Okafor\'s auto MVA death case (vehicle recall defect, airbag failure). The recipient domain has been linked to referral arrangements with 2 competing firms. This is the agent\'s second confirmed violation — first was honeypot HP-001 alert.',
    details: 'Email sent on Feb 8 at 10:15 PM containing 6 lead records including Sandra Okafor\'s case with full contact info and case types. IT flagged the outbound email. Case profile matches honeypot HP-004.',
    flaggedAt: '2026-02-08T22:20:00Z',
    indicators: ['External email detected', 'Bulk lead data including death cases', 'Known competitor contact', 'Repeat offender — also alerted on HP-001'],
  },
  {
    id: 'inv-6',
    leadId: '14',
